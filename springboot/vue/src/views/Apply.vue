<template>
  <div>
    ...
    <div style="margin: 10px 0" v-if="user.role != 'ROLE_USER'">
      ...
      <!-- <el-upload action="http://localhost:9090/apply/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
      ...
      <el-table-column label="操作" width="180" align="center" v-if="user.role != 'ROLE_USER'">
        <template slot-scope="scope">
          <el-button type="success" @click="handleEdit(scope.row)" v-if="scope.row.state === '待审核'">审核 <i
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="140px" size="small" style="width: 85%;" :model="form" :rules="rules" ref="ruleForm">
        ...
        <el-form-item prop="reason" label="审核描述">
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open("http://localhost:9090/apply/export")
    },
